...
const UTILITY_ASSET_ROOT = "/_utilities/nautical";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/nautical/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/nautical/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("nautical");
